...
class MentorDetailsScreen extends ConsumerWidget {
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Country: ${mentor.country ?? 'Unknown'}',
  ...
  Widget _buildAssignedUsersSection(
    BuildContext context,
    WidgetRef ref,
    AsyncValue<List<AppUser>> assignedUsersAsync,
    AppUser mentor,
  ) {
    return Card(
      elevation: 0,
                ...
                ElevatedButton.icon(
                  onPressed: () {
                    showDialog(
                      context: context,
                      builder: (context) =>
                          AssignUsersDialog(mentorId: mentor.uid),
                    );
                  },
